		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"providerSecretRef": {
						SchemaProps: spec.SchemaProps{
							Description: "ProviderSecretRef contains the name of the provider secret. The secret information may differ with respect to provider. It is considered optional where workload identity or IRSA (IAM Role for Service Account) is used, otherwise it is mandatory example: providerSecretRef:\n\t\tname: my-secret",
							Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
						},
					},
					"requestTimeout": {
